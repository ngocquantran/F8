...
public class VocabTest {
    ...
    public VocabTest(Long id, String word, String img, String type, String audio, String phonetic, String enMeaning, String vnMeaning, String enSentence, String vnSentence, String senAudio) {
        this.id = id;
        this.word = word;
        this.img = img;
        this.type = type;
